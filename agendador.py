...
def setup_schedule():
    ...
    schedule.every().day.at("20:40", "America/Sao_Paulo").do(job_coletar_dados_patrimonio)
    schedule.every().day.at("21:49", "America/Sao_Paulo").do(job_coletar_dados_funcionarios)
