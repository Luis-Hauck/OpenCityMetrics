...
def setup_schedule():
    ...
    schedule.every().day.at("21:14", "America/Sao_Paulo").do(job_coletar_dados_patrimonio)
    schedule.every().day.at("21:37", "America/Sao_Paulo").do(job_coletar_dados_funcionarios)
